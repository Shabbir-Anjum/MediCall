...
export default function BookingsPage() {
  ...
  const getConsultationTypeColor = (type: string) => {
    switch (type) {
      case 'in-person': return 'bg-green-50 text-green-700';
      case 'video': return 'bg-blue-50 text-blue-700';
      case 'phone': return 'bg-purple-50 text-purple-700';
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              <h3 className="font-semibold text-gray-900">{booking.patient.name}</h3>
                          ...
                          <div className="flex items-center space-x-6">
                            ...
                            <div className="flex flex-col space-y-2">
                              ...
                              <Badge variant="outline" className={getConsultationTypeColor(booking.consultationType)}>
